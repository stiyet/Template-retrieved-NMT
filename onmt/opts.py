...
def preprocess_opts(parser):
    ...
    group.add('--data_type', '-data_type', default="text",
              help="Type of the source input. "
                   "Options are [text|img|audio|vec].")
    ############============================================
    group.add('--train_tt','-train_tt',required=True,nargs='+',
              help="Path(s) to the training template data")
    group.add('--valid_tt','-valid_tt',
              help="Path to the valid template data")
