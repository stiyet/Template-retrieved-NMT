...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, heads, d_ff, dropout, attention_dropout,
        ...
        self.context_attn = MultiHeadedAttention(
            heads, d_model, dropout=attention_dropout)
        #############====================================
        self.context_attn_t = MultiHeadedAttention(
            heads, d_model, dropout=attention_dropout)

        self.feed_forward = PositionwiseFeedForward(d_model, d_ff, dropout)
        self.layer_norm_1 = nn.LayerNorm(d_model, eps=1e-6)
        #############=======================================
        self.layer_norm_t = nn.LayerNorm(d_model, eps=1e-6)
    ...
    def _forward(self, inputs, memory_bank, src_pad_mask,memory_bank_t,tt_pad_mask, tgt_pad_mask,
        ...
        ###=======================================
        query_norm_t = self.layer_norm_t(query)
        query_t,_ = self.context_attn_t(memory_bank_t,memory_bank_t,query_norm_t,
                                        mask=tt_pad_mask,
                                        layer_cache=layer_cache,
                                        attn_type="context")
        query_t = self.drop(query_t) + query
        query_norm = self.layer_norm_2(query_t)
        ...
        mid, attns = self.context_attn(memory_bank, memory_bank, query_norm,
                                       ...
                                       attn_type="context")
        ####========================================
        output = self.feed_forward(self.drop(mid) + query_t)
    ...
    def update_dropout(self, dropout, attention_dropout):
        ...
        ########======================================
        self.context_attn_t.update_dropout(attention_dropout)
...
class TransformerDecoder(DecoderBase):
    ...
    def init_state(self, src,tt, memory_bank, enc_hidden):
