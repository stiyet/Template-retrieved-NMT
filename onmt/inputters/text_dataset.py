...
def text_sort_key(ex):
    ...
    # print("text_dataset text_sort_key")
    if hasattr(ex, "tgt"):
...
class TextMultiField(RawField):
    ...
    def __init__(self, base_name, base_field, feats_fields):
        ...
        #     print(("TextMultiField init",_,field.include_lengths))
        # print("TextMultiField init")
        for name, ff in sorted(feats_fields, key=lambda kv: kv[0]):
            # print(("TextMultiField init",name,ff))
            self.fields.append((name, ff))

    @property
    def base_field(self):
        # print("TextMultiField base_field")
    ...
    def process(self, batch, device=None):
        ...
        # print("!!!!!!!!!!!!!!!!!!!do text_dataset.py TextMultiField process()!!!!!!!!!!!!!!!!")
        # print(batch)
        batch_by_feat = list(zip(*batch))
        # print(batch_by_feat[0])
        # print((self.base_field.eos_token,self.base_field.include_lengths))
    ...
    def preprocess(self, x):
        ...
        """
        # print("!!!!!!!!!!!!!!!!!!text_dataset.py preprocess!!!!!!!!!!!!!!!!!!!")
...
def text_fields(**kwargs):
    ...
    for i in range(n_feats + 1):
        ...
        # print((name,feat.include_lengths))
    assert fields_[0][0] == base_name  # sanity check
    # print((fields_[0][0], fields_[0][1], fields_[1:]))
