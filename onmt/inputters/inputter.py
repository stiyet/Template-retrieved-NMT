...
def get_fields(
    ...
    """
    # print("======================start inputter.py get_fields==================")
    ...
    # print(src_field_kwargs)
    #########======================================================
    tt_field_kwargs = {"n_feats": n_tt_feats,
                        "include_lengths": True,
                        "pad": pad, "bos": None, "eos": None,
                        "truncate": tgt_truncate,
                        "base_name": "tt"}
    fields["tt"] = fields_getters["text"](**tt_field_kwargs)
    # print(tt_field_kwargs)
...
def _build_fields_vocab(fields, counters, data_type, share_vocab,
    ...
    ##################add tt field in vocab_fields============================
    build_fv_args["tt"] = dict(
        max_size=tgt_vocab_size, min_freq=tgt_words_min_frequency)
    tt_multifield = fields["tt"]
    _build_fv_from_multifield(
        tt_multifield,
        counters,
        build_fv_args,
...
class OrderedIterator(torchtext.data.Iterator):
    ...
    def create_batches(self):
        # print("==========================inputter.py OrderIterator create_batches=========================")
        # print(self.data())
        if self.train:
            if self.yield_raw_example:
                self.batches = batch_iter(
                    ...
                    batch_size_fn=None,
                    batch_size_multiple=1)
                # print("=============yield_raw_example==========================")
            else:
                # print("===================not yield raw example====================")
                self.batches = _pool(
                    self.data(),
                    self.batch_size,
                    self.batch_size_fn,
        ...
        while True:
            ...
            for idx, minibatch in enumerate(self.batches):
                ...
                if self.yield_raw_example:
                    ...
                    # print(minibatch)
                    # print("==========return batch through torchtext.data.batch================")
...
class DatasetLazyIter(object):
    ...
    def _iter_dataset(self, path):
        ...
        # print("==========================through cur_iter get batch====================")
